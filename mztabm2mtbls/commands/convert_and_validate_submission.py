...
from mztabm2mtbls.commands.utils import load_from_url, setup_basic_logging_config
from mztabm2mtbls.opa_engine import OpaEngine


@click.command(name="convert-to-isatab")
@click.option(
...
def convert_and_validate_submission(
    ...
    """
    Convert mzTab-M file to MetaboLights ISATAB format
    ...
    try:
        ...
        if validation_result:
            ...
            violation_results = ValidationResult()
        overrides = []
        if config_file:
