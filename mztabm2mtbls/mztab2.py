...
#   filename:  mztab2.yaml
#   timestamp: 2024-08-20T17:37:18+00:00
...
class Contact(MzTabBaseModel):
    ...
    affiliation: Annotated[
        Optional[str], Field(description="The contact's affiliation.")
    ] = None
    email: Annotated[
        Optional[str],
        Field(
...
class Uri(MzTabBaseModel):
    ...
    value: Annotated[
        Optional[AnyUrl],
        Field(description="The URI pointing to the external resource."),
    ] = None
...
class Sample(MzTabBaseModel):
    ...
    custom: Annotated[
        Optional[List[Parameter]],
        Field(description="Additional user or cv parameters."),
    ] = []
    species: Annotated[
        Optional[List[Parameter]],
        Field(description="Biological species information on the sample."),
    ] = []
    tissue: Annotated[
        Optional[List[Parameter]],
        Field(description="Biological tissue information on the sample."),
    ] = []
    cell_type: Annotated[
        Optional[List[Parameter]],
        Field(description="Biological cell type information on the sample."),
    ] = []
    disease: Annotated[
        Optional[List[Parameter]],
        Field(description="Disease information on the sample."),
    ] = []
    description: Annotated[
        Optional[str], Field(description="A free form description of the sample.")
    ] = None
...
class MsRun(MzTabBaseModel):
    ...
    fragmentation_method: Annotated[
        Optional[List[Parameter]],
        Field(description="The fragmentation methods applied during this msRun."),
    ] = []
    scan_polarity: Annotated[
        Optional[List[Parameter]],
        Field(description="The scan polarity/polarities used during this msRun."),
    ] = []
    hash: Annotated[
        Optional[str],
        Field(description="The file hash value of this msRun's data file."),
    ] = None
...
class Assay(MzTabBaseModel):
    ...
    external_uri: Annotated[
        Optional[AnyUrl],
        Field(description="An external URI to further information about this assay."),
    ] = None
...
class CV(MzTabBaseModel):
    ...
    full_name: Annotated[
        str, Field(description="The full name of this CV, for humans.")
    ]
    version: Annotated[
        str, Field(description="The CV version used when the file was generated.")
    ]
...
class SmallMoleculeSummary(MzTabBaseModel):
    ...
    sml_id: Annotated[
        int,
        Field(description="A within file unique identifier for the small molecule."),
    ]
...
class Publication(MzTabBaseModel):
    ...
    publicationItems: Annotated[
        ...
        Field(description="The publication item ids referenced by this publication."),
    ]
...
class StudyVariable(MzTabBaseModel):
    ...
    assay_refs: Annotated[
        Optional[List[int]],
        Field(description="The assays referenced by this study variable."),
    ] = []
...
class Metadata(MzTabBaseModel):
    ...
    small_molecule_quantification_unit: Annotated[
        Parameter, Field(alias="small_molecule-quantification_unit")
    ]
    small_molecule_feature_quantification_unit: Annotated[
        Parameter, Field(alias="small_molecule_feature-quantification_unit")
    ]
    small_molecule_identification_reliability: Annotated[
        Optional[Parameter], Field(alias="small_molecule-identification_reliability")
    ] = None
    database: Annotated[
        List[Database],
        Field(
...
class MzTab(MzTabBaseModel):
    ...
    smallMoleculeEvidence: Annotated[
